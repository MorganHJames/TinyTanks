...
void Vector4::rotateZ(const float a_c_fAngle)//A Rotate function that takes in an angle in float format.
{
...
void Vector4::rotateX(const float a_c_fAngle)//A Rotate function that takes in an angle in float format.
{
	degreesToRadians(a_c_fAngle);//Converts the float to radians.
...
void Vector4::rotateY(const float a_c_fAngle)//A Rotate function that takes in an angle in float format.
{
	degreesToRadians(a_c_fAngle);//Converts the float to radians.
